...
from src.infrastructure.web.routers.ai_news import router as ai_news_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(ai_news_router, prefix="/api")  # AI news router with /api/ai-news prefix
